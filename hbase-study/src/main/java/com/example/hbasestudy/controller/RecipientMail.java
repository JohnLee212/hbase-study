...
public class RecipientMail {
    ...
    //收件人地址
    public static String recipientAddress = "lwx18848956826@@163.com";
    //收件人账户名
    public static String recipientAccount = "18848956826@163.com";
    //收件人账户密码
    public static String recipientPassword = "li150187@";
